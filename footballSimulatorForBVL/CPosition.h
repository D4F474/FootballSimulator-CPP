...
class CPosition 
{
	private:
		...
		float STAMINA = 0.0;
		float STRENGTH = 0.0;
		float SPRINT_SPEED = 0.0;
		float VISION = 0.0;
		float SLIDE_TACKLE = 0.0;
		float STAND_TACKLE = 0.0;
		float BALL_CONTROLL = 0.0;
		float DRIBBLING = 0.0;
		float CROSSING = 0.0;
		float SHORT_PASS = 0.0;
		float LONG_PASS = 0.0;
		float HEADING = 0.0;
		...
		float PENALTIES = 0.0;
		float FINISHING = 0.0;
		float GK_POSSITIONING = 0.0;
		float GK_DIVING = 0.0;
		float GK_HANDLING = 0.0;
		float GK_KICKING = 0.0;
		float GK_REFLEXES = 0.0;
		float OVR = 0.0;
	public:
		CPosition();
